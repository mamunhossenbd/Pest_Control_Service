                ...
                <section class="content">
                    <div class="card">
                        <div class="card-header bg-success">
                            <div class="row">
                                <div class="col-md-6">
                                <h3 class="card-header">Testimonial List</h3>
                                </div>
                                <div class="col-md-6">
                                <h2 class="card-title" style="padding-left: 70%">
                                    <router-link to="d_testimonial" class="btn btn-primary"
                        ...
                        <div class="card-body bg-dark">
                            <table class="table table-bordered">
                                ...
                                <tr v-for="(d, i) in testimonial" :key="i">
                                    <td>{{ ++i }}</td>
                                    <td>{{ d.name }}</td>
                                    <td>{{ d.designation }}</td>
                                    <td>{{ d.comment }}</td>
